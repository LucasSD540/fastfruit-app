    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                <AppText style={styles.adressInfoText}>QS 7 - Taguatinga, Brasília - DF</AppText>
                <View>
                    <Image />
                </View>
                ...
                <View style={styles.productContainer}>
                    <View style={styles.productDiv}>
                        <Image style={styles.productImage} source={require("../assets/brocolis.png")} />
                ...
                <View style={styles.productLastStoreContainer}>
                    <View style={styles.productDivLastStore}>
                        <Image style={styles.productImage} source={require("../assets/brocolis.png")} />
                        <AppText style={styles.productName}>HortiFruti - Taguatinga</AppText>
                    </View>
                    <View style={styles.productDivLastStore}>
                        <Image style={styles.productImage} source={require("../assets/brocolis.png")} />
                        <AppText style={styles.productName}>Oba HortiFruti - Taguatinga </AppText>
                    </View>
                </View>
                ...
                <View style={styles.productStoreContainer}>
                    <View style={styles.flexStoreContainer}>
                        ...
                        <View style={styles.flexNameDiv}>
                            <AppText style={styles.storeName}>HortiFruti - Taguatinga</AppText>
                            <Image style={styles.favoriteImage} source={require("../assets/favorite_icon.png")} />
                        </View>
                    </View>
                    <View style={styles.flexStoreContainer}>
                        <View style={styles.productDivFavorites}>
